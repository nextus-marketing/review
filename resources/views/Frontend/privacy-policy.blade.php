...
<div class="post-content">
    <div class="post-entry">
      ...
      7340 Lee Hwy, Falls Church, </br> VA, 22046
        ...
        <ul class="wow fadeInUp" data-wow-delay="1.2s" style="font-size: 13px;">
            <li style="font-size: 13px;"><strong>Identifiers,</strong> such as full name, postal address, shipping address, internet protocol (IP) address, primary and secondary phone numbers, e-mail address, and customer record information, including caller ANI, account number, and service address;</li>
            <li style="font-size: 13px;"><strong> Payment-related information,</strong> including bank account or credit card information;</li>
            <li style="font-size: 13px;"><strong>Audio information,</strong> including voice recordings of telephone calls;</li>
            <li style="font-size: 13px;"><strong> Communications and other content,</strong> including other personal information you may provide through webforms, chat, and other means;</li>
            <li style="font-size: 13px;"><strong> Internet or network activity,</strong>such as you interaction with an advertisement, and other information obtained from cookies and clear gifs, as described further below.</li>
        </ul>

 <p style="font-size: 13px;" class="wow fadeInUp" data-wow-delay="1.4s">Some of the personal information we collect, such as legally protected characteristics and health information, may be considered sensitive personal information under applicable law. When we collect or process sensitive personal information, we do so with your consent, or as permitted by applicable law.
</br></br>
  ...
  <div class="table-responsive" style="border:1px solid #ddd; border-radius:4px; overflow:auto;">
    <table class="table table-bordered mb-0" style="min-width:1100px; border-color:#cfcfcf;">
      <thead style="background:#f3f3f3;">
        <tr>
          <th style="width:38%;">Type of Sensitive Information</th>
          <th style="width:14%;">Is this collected?</th>
          <th style="width:28%;">How will it be used?</th>
...
<p style="font-size: 13px;">Depending on your state of residence, you may request that use of your sensitive personal information be limited by filling out the form titled "Limit Use of My Sensitive Personal Information" linked at the bottom of this privacy policy or in the footer of this webpage, or by contacting us at <a href="tel:+15715008149">+1(571) 500-8149</a> . If you are a resident of certain states, we do not collect or process your sensitive data (as defined in those states' laws) without your consent.</p>
<p style="font-size: 13px;">We may collect personal information (including sensitive personal information and other personal information) at the following times:</p>
 <ul class="wow fadeInUp" data-wow-delay="1.2s">
      <li style="font-size: 13px;">when you register to receive communications from this website or any website owned by the owner of comparehomesecurity.org</li>
      <li style="font-size: 13px;">when you seek information or apply for products and services offered through this website or any website </li>
      <li style="font-size: 13px;"> when you enter promotions or sweepstakes offered by this website or any website </li>
      <li style="font-size: 13px;">when you provide personal information to us through feedback, survey, or other forms hosted on this site or any website </li>
      <li style="font-size: 13px;"> when you visit our Web Site, including through cookies and clear gifs, as described further below,</li>
      <li style="font-size: 13px;">when you contact us.</li>
  </ul>
  
  <section style="padding:15px; line-height:1.6; ">
  <h6 style=" margin-bottom:12px;">Cookies and IP Addresses</h6>
  <p style="font-size: 13px;">To serve you more efficiently and effectively, we use "cookies" technology. A cookie is a piece of data stored on the user's hard drive that contains information about the user. Cookies are linked to particular devices over time, and may be linked to other personal information we obtain.</p>
  <p style="font-size: 13px;">Cookies enable a website to "personalize" itself for each user and reduce the time it takes for pages to load on your computer. In order to optimize your experience, cookies also help with the collection of customer tracking data. We may also capture customer tracking data on some of our partners' websites related to activity involved with the completion of offers listed on our website. This information is used to monitor the performance of our partners.</p>
  <p style="font-size: 13px;">If you reject cookies, you may still use our site, but your ability to use some areas of our site will be limited. We also keep track of Internet Protocol (IP) addresses and may disclose your IP address during the course and scope of our business. An IP Address is a number used by computers on the network to identify your computer every time you log on to the Internet.</p>
  <p style="font-size: 13px;">Your browser or device may offer settings that allow you to choose whether browser cookies are set and to delete them. For more information about these controls and to exercise your cookie preferences, visit your browser or device's help material. If you choose to reject cookies, you may not be able to use certain features of our websites and services. To learn more about Cookies, visit <a href="https://www.allaboutcookies.org" target="_blank">https://www.allaboutcookies.org</a>.</p>
  <p style="font-size: 13px;">We permit some of our non-affiliated business partners (e.g., advertisers) to use cookies on our site. We maintain relationships with a number of the third-party ad networks currently operating. You may find more information at the website of either the individual ad network or the Network Advertising Initiative. We have no access to or control over information collected from such cookies. This Privacy Policy covers the use of our cookies only and does not cover the use of cookies by any advertisers.</p>
  <p style="font-size: 13px;">When you visit or log in to our website, cookies and similar technologies may be used to associate these activities with other personal information we have about you, including by association with your email or home address. We (or service providers on our behalf) may then send communications and marketing to these email or home addresses. You may opt out of receiving this advertising by submitting an opt-out request using our Consumer Privacy Rights Request Form.</p>

  <h6 style=" margin-top:18px;">Clear Gifs</h6>
  <p style="font-size: 13px;">We employ a software technology called clear gifs, also known as Web Beacons, that help us better manage content on our site by informing us what content is effective. Clear gifs are tiny graphics with a unique identifier, similar in function to cookies, and are used to track the online movement of Web users.</p>
  <p style="font-size: 13px;">We also use clear gifs in our HTML-based emails to let us know which emails the recipients have opened. This allows us to gauge the effectiveness of certain communications and marketing campaigns. If users would like to opt-out of these emails, please see the Opt-out section within any email you receive from us.</p>
    
  <h6 style=" margin-top:18px;">Telephone Calls and Recordings</h6>
  <p style="font-size: 13px;">You provide your prior express written consent to receive marketing telephone calls and text messages (including those sent by automatic telephone dialing systems and including prerecorded or artificial voices) to any telephone number that you provide to us, even if that number is listed on a do-not-call registry. Consent is not a condition of purchasing any goods or services.</p>
  <p style="font-size: 13px;">You also agree that all telephone calls and conversations with us and anyone we may transfer your call to or from may be recorded for quality, customer service, compliance, and regulatory purposes.</p>

  <h6 style=" margin-top:18px;">Information Selling, Sharing and Use for Targeted Advertising</h6>
  <p style="font-size: 13px;">We may sell, share, or use (for targeted advertising purposes) your personal information, as those terms are defined by applicable laws. We may disclose your personal information for such purposes to the following categories of third parties:</p>
  <ul>
    <li style="font-size: 13px;">Partners, sponsors, advertisers, service providers, and marketing lookup and reference services that provide Consumers with special offers and opportunities related to your requests.</li>
    <li style="font-size: 13px;">Aggregated information shared with select companies that wish to reach a particular Consumer audience (e.g., demographic targeting).</li>
    <li style="font-size: 13px;">Advertisers who may receive identifiers and health information in compliance with applicable laws.</li>
  </ul>
  <p style="font-size: 13px;">In the past 12 months, we have sold or shared identifiers and health information, and disclosed identifiers, audio information, communications, and network activity for business purposes.</p>

  <h6 style=" margin-top:18px;">Other Transfers of Information to Third Parties</h6>
  <ul style="font-size: 13px;">
    <li style="font-size: 13px;">When you request quotes or contact through our site, we may share your information with partners who contact you by phone, SMS, email, or mail.</li>
    <li style="font-size: 13px;">We use third-party vendors to operate portions of our site or services; these vendors are required to comply with our Privacy Policy.</li>
    <li style="font-size: 13px;">We may share information to comply with laws, respond to legal requests, or protect rights or property.</li>
    <li style="font-size: 13px;">We may transfer data in connection with mergers, sales, or acquisitions. Any successor company remains bound by this policy.</li>
  </ul>

  <h6 style=" margin-top:18px;">Marketing Opt-Out</h6>
  <p style="font-size: 13px;">You can opt out of marketing communications or newsletters by following unsubscribe instructions or contacting us. You may continue to receive emails for up to ten business days after opting out.</p>

  <h6 style=" margin-top:18px;">Third Party Links</h6>
  <p style="font-size: 13px;">This Privacy Policy applies only to information collected by comparehomesecurity.org  When you visit other linked sites, their privacy and cookie policies apply. Please review third-party policies before submitting information.</p>

  <h6 style=" margin-top:18px;">Minors</h6>
  <p style="font-size: 13px;">You must be at least 18 years old to use this website. We do not knowingly collect, use, or disclose personal information from individuals under 18 years of age.</p>

  <h6 style=" margin-top:18px;">Updating Your Information</h6>
  <p style="font-size: 13px;">If you want to access or update your personal information, please email <a href="mailto:offers@comparehomesecurity.org">offers@comparehomesecurity.org</a> or write to:</p>
  <ul>
    <li style="font-size: 13px;">comparehomesecurity.org Attn: Customer Care<br>7340 Lee Hwy, Falls Church<br>VA, 22046</li>
  </ul>

  <h6 style=" margin-top:18px;">Questions and Suggestions</h6>
  <p style="font-size: 13px;">Contact us via:</p>
  <ul>
    <li style="font-size: 13px;">Email: <a href="mailto:offers@comparehomesecurity.org">offers@comparehomesecurity.org</a></li>
    <li style="font-size: 13px;">Location: 7340 Lee Hwy, Falls Church, VA, 22046</li>
  </ul>
    
  <h6 style=" margin-top:18px;">Retention</h6>
  <p style="font-size: 13px;">We retain personal information only as long as necessary to fulfill purposes described above or as required by law.</p>
  <ul>
    <li style="font-size: 13px;">Our relationship with you and the services provided</li>
    <li style="font-size: 13px;">Your requests and communications</li>
    <li style="font-size: 13px;">Legal obligations or enforcement requirements</li>
    <li style="font-size: 13px;">Technical considerations and data protection measures</li>
  </ul>

  <h6 style=" margin-top:18px;">Changes to this Privacy Policy</h6>
  <p style="font-size: 13px;">We reserve the right to update or modify this policy at any time. Changes will be posted on our site and dated accordingly. Continued use of the site signifies acceptance of updates.</p>

  <h6 style=" margin-top:18px;">Your Privacy Rights</h6>
  <p style="font-size: 13px;">Depending on your U.S. state of residence, you may have rights regarding your personal information, including:</p>
  <ul>
    <li style="font-size: 13px;"><strong>Access/Portability:</strong> Request confirmation or a report of personal data collected.</li>
    <li style="font-size: 13px;"><strong>Correction:</strong> Request correction of inaccurate personal information.</li>
    <li style="font-size: 13px;"><strong>Deletion:</strong> Request deletion of your data, subject to legal exceptions.</li>
    <li style="font-size: 13px;"><strong>Opt-Out:</strong> Opt out of data sale, sharing, or targeted advertising.</li>
    <li style="font-size: 13px;"><strong>Limit Sensitive Information:</strong> Request limited use of sensitive personal data.</li>
    <li style="font-size: 13px;"><strong>Non-Discrimination:</strong> You will not be discriminated against for exercising privacy rights.</li>
    <li style="font-size: 13px;"><strong>Appeal:</strong> Appeal any declined requests.</li>
  </ul>

  <p style="font-size: 13px;">For assistance, contact:</p>
  <ul>
    <li style="font-size: 13px;">Contact Number:<a href="tel:+15715008149">+1(571) 500-8149</a></li>
    <li style="font-size: 13px;">Email: <a href="mailto:offers@comparehomesecurity.org">offers@comparehomesecurity.org</a></li>
  </ul>

  <p style="font-size: 13px;"><strong>California Residents:</strong> You may opt out of data sharing per California’s Shine the Light Law by contacting <a href="mailto:offers@comparehomesecurity.org">offers@comparehomesecurity.org</a> or by mail as listed above.</p>

  <p style="font-size: 13px;"><em>Last Updated: 11-12-2025</em></p>
</section>
